...
VCM configuration can execute shell and Python hooks with the invoking user's privileges. Only run trusted configuration and runner executables. Installation checksums detect corrupted or mismatched downloads; release trust also depends on GitHub and the publisher. Verify published build provenance where your environment requires it.
